                            ...
                            <div class="row">
                                <div class="col-lg-5">
                                    ...
                                    <p>Cover up front of book and
                                        <br>leave summary</p>
                                    <a href="{{ route('shop-grid') }}" class="btn btn-outlined--pink">
                                        Shop Now
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="row justify-content-end">
                                <div class="col-lg-8">
                                    ...
                                    <h2>Cover up front of book and
                                        leave summary</h2>
                                    <a href="{{ route('shop-grid') }}" class="btn btn--yellow">
                                        Shop Now
                                    </a>
                                </div>
                            </div>
                                ...
                                <div class="product-card card-style-list">
                                    ...
                                    <div class="product-card--body">
                                        <div class="product-header">
                                            ...
                                            <h3><a href="{{ route('product-details') }}">Get Through To Your
                                                    BOOK</a></h3>
                                        </div>
                                ...
                                <div class="product-card card-style-list">
                                    ...
                                    <div class="product-card--body">
                                        <div class="product-header">
                                            ...
                                            <h3><a href="{{ route('product-details') }}">What Can You Do To Save Your
                                                    BOOK</a></h3>
                                        </div>
                                        <div class="price-block">
                                            <span class="price">£51.20</span>
                                ...
                                <div class="product-card card-style-list">
                                    ...
                                    <div class="product-card--body">
                                        <div class="product-header">
                                            ...
                                            <h3><a href="{{ route('product-details') }}">From Destruction By Social
                                                    Media?</a></h3>
                                        </div>
                                        <div class="price-block">
                                            <span class="price">£51.20</span>
                                ...
                                <div class="product-card card-style-list">
                                    ...
                                    <div class="product-card--body">
                                        <div class="product-header">
                                            ...
                                            <h3><a href="{{ route('product-details') }}">Find Out More About BOOK ?</a></h3>
                                        </div>
                                        <div class="price-block">
                                            <span class="price">£51.20</span>
                                            <del class="price-old">£51.20</del>
                                ...
                                <div class="product-card card-style-list">
                                    ...
                                    <div class="product-card--body">
                                        <div class="product-header">
                                            ...
                                            <h3><a href="{{ route('product-details') }}">Controversial BOOK
                                                    Social Media?</a></h3>
                                        </div>
                                        <div class="price-block">
                                            <span class="price">£51.20</span>
                                    ...
                                    <div class="product-card--body">
                                        <div class="product-header">
                                            <a href="" class="author">
                                                ...
                                                <h3><a href="{{ route('product-details') }}">Lightweight
                                    ...
                                    <div class="product-card--body">
                                        <div class="product-header">
                                            <a href="" class="author">
                                                ...
                                                <h3><a href="{{ route('product-details') }}">Ways To Have More
                                                        BOOK</a></h3>
                                        </div>
                                        <div class="price-block">
                                            <span class="price">£51.20</span>
                                    ...
                                    <div class="product-card--body">
                                        <div class="product-header">
                                            <a href="" class="author">
                                                ...
                                                <h3><a href="{{ route('product-details') }}">10 Minutes, I'll Give You
                                                        The Truth</a></h3>
                                        </div>
                                        <div class="price-block">
                                            <span class="price">£51.20</span>
                                ...
                                <div class="product-card">
                                    <div class="product-header">
                                        <a href="" class="author">
                                            ...
                                            <h3><a href="{{ route('product-details') }}">BOOK: Do You Really Need It? This
                                                    Will Help You</a></h3>
                                    </div>
                                    <div class="product-card--body">
                                        <div class="card-image">
                                ...
                                <div class="product-card">
                                    <div class="product-header">
                                        <a href="" class="author">
                                            ...
                                            <h3><a href="{{ route('product-details') }}">Here Is A Quick Cure For BOOK
                                                    This Will Help</a></h3>
                                    </div>
                                    <div class="product-card--body">
                                        <div class="card-image">
                                ...
                                <div class="product-card">
                                    <div class="product-header">
                                        <a href="" class="author">
                                            ...
                                            <h3><a href="{{ route('product-details') }}">Simple Things
                                ...
                                <div class="product-card">
                                    <div class="product-header">
                                        <a href="" class="author">
                                            ...
                                            <h3><a href="{{ route('product-details') }}">What You Can Learn From Bill
                                ...
                                <div class="product-card">
                                    <div class="product-header">
                                        <a href="" class="author">
                                            ...
                                            <h3><a href="{{ route('product-details') }}">3 Ways Create Better BOOK With
                                ...
                                <div class="product-card">
                                    <div class="product-header">
                                        <a href="" class="author">
                                            ...
                                            <h3><a href="{{ route('product-details') }}">Turn Your BOOK Into A High
                                            ...
                                            <div class="product-card">
                                                <div class="product-header">
                                                    <a href="" class="author">
                                                        ...
                                                        <h3><a href="{{ route('product-details') }}">Rpple iPad with
                                                                Retina Display</a></h3>
                                                </div>
                                                <div class="product-card--body">
                                                    <div class="card-image">
                                            ...
                                            <div class="product-card">
                                                <div class="product-header">
                                                    <a href="" class="author">
                                                        ...
                                                        <h3><a href="{{ route('product-details') }}">Koss Lightweight
                                                                    Headphone</a></h3>
                                                </div>
                                                <div class="product-card--body">
                                                    <div class="card-image">
                                            ...
                                            <div class="product-card">
                                                <div class="product-header">
                                                    <a href="" class="author">
                                                        ...
                                                        <h3><a href="{{ route('product-details') }}">Beats Wired On-Ear
                                            ...
                                            <div class="product-card">
                                                <div class="product-header">
                                                    <a href="" class="author">
                                                        ...
                                                        <h3><a href="{{ route('product-details') }}">Beats Solo2 Solo 2
                                                                Wired On-Ear</a></h3>
                                                </div>
                                                <div class="product-card--body">
                                                    <div class="card-image">
                                            ...
                                            <div class="product-card">
                                                <div class="product-header">
                                                    <a href="" class="author">
                                                        ...
                                                        <h3><a href="{{ route('product-details') }}">Beats Solo3 Wireless
                                                                Headphones 2</a></h3>
                                                </div>
                                                <div class="product-card--body">
                                                    <div class="card-image">
                                            ...
                                            <div class="product-card">
                                                <div class="product-header">
                                                    <a href="" class="author">
                                                        ...
                                                        <h3><a href="{{ route('product-details') }}">Ways To Have
                                                                Appealing BOOK</a></h3>
                                                </div>
                                                <div class="product-card--body">
                                                    <div class="card-image">
                                            ...
                                            <div class="product-card">
                                                <div class="product-header">
                                                    <a href="" class="author">
                                                        ...
                                                        <h3><a href="{{ route('product-details') }}">10 Minutes, I'll
                                            ...
                                            <div class="product-card">
                                                <div class="product-header">
                                                    <a href="" class="author">
                                                        ...
                                                        <h3><a href="{{ route('product-details') }}">Ways To Get Through
                                                                BOOK</a></h3>
                                                </div>
                                                <div class="product-card--body">
                                                    <div class="card-image">
                                            ...
                                            <div class="product-card">
                                                <div class="product-header">
                                                    <a href="" class="author">
                                                        ...
                                                        <h3><a href="{{ route('product-details') }}">What Can You Do To
                                                                Save Your BOOK</a></h3>
                                                </div>
                                                <div class="product-card--body">
                                                    <div class="card-image">
                                            ...
                                            <div class="product-card">
                                                <div class="product-header">
                                                    <a href="" class="author">
                                                        ...
                                                        <h3><a href="{{ route('product-details') }}">From Destruction By
                                                                Social Media?</a></h3>
                                                </div>
                                                <div class="product-card--body">
                                                    <div class="card-image">
                                            ...
                                            <div class="product-card">
                                                <div class="product-header">
                                                    <a href="" class="author">
                                                        ...
                                                        <h3><a href="{{ route('product-details') }}">Find Out More About
                                                                BOOK ?</a></h3>
                                                </div>
                                                <div class="product-card--body">
                                                    <div class="card-image">
                                            ...
                                            <div class="product-card">
                                                <div class="product-header">
                                                    <a href="" class="author">
                                                        ...
                                                        <h3><a href="{{ route('product-details') }}">Read This
                                            ...
                                            <div class="product-card">
                                                <div class="product-header">
                                                    <a href="" class="author">
                                                        ...
                                                        <h3><a href="{{ route('product-details') }}">iPad with
                                                                Retina Display</a></h3>
                                                </div>
                                                <div class="product-card--body">
                                                    <div class="card-image">
                                                ...
                                                <div class="product-card card-style-list">
                                                    ...
                                                    <div class="product-card--body">
                                                        <div class="product-header">
                                                            ...
                                                            <h3><a href="{{ route('product-details') }}">5 Ways To Get
                                                ...
                                                <div class="product-card card-style-list">
                                                    ...
                                                    <div class="product-card--body">
                                                        <div class="product-header">
                                                            ...
                                                            <h3><a href="{{ route('product-details') }}">What Can You Do
                                                ...
                                                <div class="product-card card-style-list">
                                                    ...
                                                    <div class="product-card--body">
                                                        <div class="product-header">
                                                            ...
                                                            <h3><a href="{{ route('product-details') }}">From Destruction
                                                ...
                                                <div class="product-card card-style-list">
                                                    ...
                                                    <div class="product-card--body">
                                                        <div class="product-header">
                                                            ...
                                                            <h3><a href="{{ route('product-details') }}">Find Out More
                                                                    About BOOK ?</a></h3>
                                                        </div>
                                                        <div class="price-block">
                                                            <span class="price">£51.20</span>
                                                ...
                                                <div class="product-card card-style-list">
                                                    ...
                                                    <div class="product-card--body">
                                                        <div class="product-header">
                                                            ...
                                                            <h3><a href="{{ route('product-details') }}">
                                                ...
                                                <div class="product-card card-style-list">
                                                    ...
                                                    <div class="product-card--body">
                                                        <div class="product-header">
                                                            ...
                                                            <h3><a href="{{ route('product-details') }}">Koss
                                                ...
                                                <div class="product-card card-style-list">
                                                    ...
                                                    <div class="product-card--body">
                                                        <div class="product-header">
                                                            ...
                                                            <h3><a href="{{ route('product-details') }}">In 10 Minutes,
                                                ...
                                                <div class="product-card card-style-list">
                                                    ...
                                                    <div class="product-card--body">
                                                        <div class="product-header">
                                                            ...
                                                            <h3><a href="{{ route('product-details') }}">Lorem ipsum dolor
