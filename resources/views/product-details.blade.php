                ...
                <div class="single-slide">
                    <div class="product-card">
                        <div class="product-header">
                            ...
                            <h3><a href="{{ route('product-details') }}">Revolutionize Your BOOK With</a></h3>
                        </div>
                ...
                <div class="single-slide">
                    <div class="product-card">
                        <div class="product-header">
                            ...
                            <h3><a href="{{ route('product-details') }}">Turn Your BOOK Into High Machine</a>
                            </h3>
                        </div>
                        <div class="product-card--body">
                            <div class="card-image">
                ...
                <div class="single-slide">
                    <div class="product-card">
                        <div class="product-header">
                            ...
                            <h3><a href="{{ route('product-details') }}">What You Can Learn From Bill Gates</a>
                            </h3>
                        </div>
                        <div class="product-card--body">
                            <div class="card-image">
                ...
                <div class="single-slide">
                    <div class="product-card">
                        <div class="product-header">
                            ...
                            <h3><a href="{{ route('product-details') }}">a Half Very Simple Things You To</a></h3>
                        </div>
                        <div class="product-card--body">
                            <div class="card-image">
