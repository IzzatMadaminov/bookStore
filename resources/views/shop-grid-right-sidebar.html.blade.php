							...
							<div class="product-list-content">
								...
								<div class="product-card--body">
									<div class="product-header">
										...
										<h3><a href="{{ route('product-details') }}" tabindex="0">Qpple cPad with Retina
							...
							<div class="product-list-content">
								...
								<div class="product-card--body">
									<div class="product-header">
										...
										<h3><a href="{{ route('product-details') }}" tabindex="0">What You Can Learn From
												Bill Gates</a></h3>
									</div>
									<article>
										<h2 class="sr-only">Card List Article</h2>
							...
							<div class="product-list-content">
								...
								<div class="product-card--body">
									<div class="product-header">
										...
										<h3><a href="{{ route('product-details') }}" tabindex="0">OMG! The Best BOOK
												Ever!</a></h3>
									</div>
									<article>
										<h2 class="sr-only">Card List Article</h2>
							...
							<div class="product-list-content">
								...
								<div class="product-card--body">
									<div class="product-header">
										...
										<h3><a href="{{ route('product-details') }}" tabindex="0">BOOK: Do You Really Need
						...
						<div class="product-card">
							<div class="product-grid-content">
								<div class="product-header">
									...
									<h3><a href="{{ route('product-details') }}">Little Known Ways To Rid Yourself</a>
									</h3>
								</div>
								<div class="product-card--body">
									<div class="card-image">
							...
							<div class="product-list-content">
								...
								<div class="product-card--body">
									<div class="product-header">
										...
										<h3><a href="{{ route('product-details') }}" tabindex="0">Revolutionize Your BOOK
