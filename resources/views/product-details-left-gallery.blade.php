...
<main class="inner-page-sec-padding-bottom">
			...
			<div class="col-lg-6">
				<div class="product-details-info pl-lg--30 ">
					...
					<div class="compare-wishlist-row">
						<a href="{{ route('wishlist') }}" class="add-link"><i class="fas fa-heart"></i>Add to Wish
							List</a>
						<a href="{{ route('compare') }}" class="add-link"><i class="fas fa-random"></i>Add to Compare</a>
					</div>
	...
	<div class="social-share rounded-icons transparent-bg text-left">
		...
		<li><div class="icon"><img src="./image/icon/policy-icon-1.png" alt=""></div><p>Security policy (edit with Customer reassurance module)</p></li>
		<li><div class="icon"><img src="./image/icon/policy-icon-2.png" alt=""></div><p>Delivery policy (edit with Customer reassurance module)</p></li>
		<li><div class="icon"><img src="./image/icon/policy-icon-3.png" alt=""></div><p>Return policy (edit with Customer reassurance module)</p></li>
		</ul> -->
				</div>
			</div>
		</div>
