				...
				<div class="product-card">
					<div class="product-grid-content">
						<div class="product-header">
							...
							<h3><a href="{{ route('product-details') }}">Here Is A Quick Cure For Book</a></h3>
						</div>
					...
					<div class="product-list-content">
						...
						<div class="product-card--body">
							<div class="product-header">
								...
								<h3><a href="{{ route('product-details') }}" tabindex="0">Qpple cPad with Retina Display
										MD510LL/A</a></h3>
							</div>
							<article>
					...
					<div class="product-list-content">
						...
						<div class="product-card--body">
							<div class="product-header">
								...
								<h3><a href="{{ route('product-details') }}" tabindex="0">What You Can Learn From Bill
										Gates</a></h3>
							</div>
							<article>
								<h2 class="sr-only">Card List Article</h2>
					...
					<div class="product-list-content">
						...
						<div class="product-card--body">
							<div class="product-header">
								...
								<h3><a href="{{ route('product-details') }}" tabindex="0">Never Changing BOOK Will
				...
				<div class="product-card">
					<div class="product-grid-content">
						<div class="product-header">
							...
							<h3><a href="{{ route('product-details') }}">How Deal With Very Bad BOOK</a></h3>
						</div>
						<div class="product-card--body">
							<div class="card-image">
					...
					<div class="product-list-content">
						...
						<div class="product-card--body">
							<div class="product-header">
								...
								<h3><a href="{{ route('product-details') }}" tabindex="0">OMG! The Best BOOK Ever!</a>
								</h3>
							</div>
							<article>
								<h2 class="sr-only">Card List Article</h2>
				...
				<div class="product-card">
					<div class="product-grid-content">
						<div class="product-header">
							...
							<h3><a href="{{ route('product-details') }}">The Hidden Mystery Behind</a></h3>
						</div>
						<div class="product-card--body">
							<div class="card-image">
								<img src="image/products/product-10.jpg" alt="">
					...
					<div class="product-list-content">
						...
						<div class="product-card--body">
							<div class="product-header">
								...
								<h3><a href="{{ route('product-details') }}" tabindex="0">BOOK: Do You Really Need It?
				...
				<div class="product-card">
					<div class="product-grid-content">
						<div class="product-header">
							...
							<h3><a href="{{ route('product-details') }}">Little Known Ways To Rid Yourself</a></h3>
						</div>
						<div class="product-card--body">
							<div class="card-image">
					...
					<div class="product-list-content">
						...
						<div class="product-card--body">
							<div class="product-header">
								...
								<h3><a href="{{ route('product-details') }}" tabindex="0">Revolutionize Your BOOK With
				...
				<div class="product-card">
					<div class="product-grid-content">
						<div class="product-header">
							...
							<h3><a href="{{ route('product-details') }}">Qple GPad with Retina Sisplay</a></h3>
						</div>
						<div class="product-card--body">
							<div class="card-image">
								<img src="image/products/product-2.jpg" alt="">
					...
					<div class="product-list-content">
						...
						<div class="product-card--body">
							<div class="product-header">
								...
								<h3><a href="{{ route('product-details') }}" tabindex="0">Here Is A Quick Cure For
										Book</a></h3>
							</div>
							<article>
								<h2 class="sr-only">Card List Article</h2>
